...
def approve(
    ...
    # Deposit/admin approval only unlocks the extended questionnaire.
    # Full generation must NOT start here. It starts only after design selection.
    db.refresh(order)

    return {
        "status": "approved",
        "order_id": order.id,
        "message": "Payment approved. Extended questionnaire is unlocked.",
    }
